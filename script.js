    ...
    //********Question Constructer********** 
        ...
        return {
            ...
            addPerson: function(){
                ...
                if(personLocalStorage.getPersonData().length > 1){
...
var UIController = (function() {
    ...
    var domItems =  {
        ...
        questUptadeBtn: document.getElementById("question-update-btn"),
    ...
    return {
        ...
        editQuestsList: function(event, storageQuestList, addInpsDynFn, uptadeQuestionListFn){
            ...
            if('question-'.indexOf(event.target.id)) { 
               ...
               for(var x = 0; x < foundItem.options.length; x++){
                   ...
                   '" name="answer" value="' + x + '"><input type="text" class="admin-option admin-option-' + x + '" value="' + foundItem.options[x] + '"></div>'

               }
               domItems.adminOptionsContainer.innerHTML = optionHTML;

               domItems.questUptadeBtn.style.visibility = 'visible';
               ...
               var backDefaultView = function() {
                    var updatedOptions;
                        ...
                        domItems.questUptadeBtn.style.visibility = 'hidden';
                        domItems.questDeleteBtn.style.visibility = 'hidden';
                        domItems.questInsertBtn.style.visibility = 'visible';
                        domItems.questsClearBtn.style.pointerEvents = '';
                        
                        uptadeQuestionListFn(storageQuestList);

               }

               var uptadeQuestion = function(){ 
               ...
               domItems.questUptadeBtn.onclick = uptadeQuestion;
        ...
        newDesign: function(ansResult, selectedAnswer){
           ...
           domItems.quizoptionsWrapper.style.cssText = 'opacity: 0.6; pointer-event: none;';
       ...
       getFullName: function(currPerson, storageQuestList, admin){
        ...
        addResultOnPanel: function(userData){
            ...
            for(var i = 0; i < userData.getPersonData().length; i++){
                ...
                console.log(userData.getPersonData()[i].firstname)
...
var contoller = (function(quizCtrl, UICtrl){
    ...
    selectedDomItems.questInsertBtn.addEventListener('click',function(){ 
        ...
        var checkeBoolean = quizCtrl.addQuestionOnLocalStorage(selectedDomItems.newQuestionText, adminOptions);
    ...
    selectedDomItems.insertedQuestsWrapper.addEventListener('click',function(e){
        ...
        UICtrl.editQuestsList(e, quizCtrl.getQuestionLocalStorage, UICtrl.addInputDynamically, UICtrl.createQuestionList);
    ...
    selectedDomItems.quizoptionsWrapper.addEventListener('click',function(e){
        ...
        var uptadedOptionsDiv = selectedDomItems.quizoptionsWrapper.querySelectorAll("div");

        for(var i = 0; i < uptadedOptionsDiv.length; i++){
